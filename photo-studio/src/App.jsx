    ...
    <HelmetProvider>
      ...
      <BrowserRouter>
        ...
        <a 
          ...
          className="fixed bottom-6 right-6 bg-[#25D366] text-white p-3 md:p-4 rounded-full shadow-lg hover:scale-110 hover:shadow-xl transition-all duration-300 z-[9999] flex items-center justify-center cursor-pointer group"
